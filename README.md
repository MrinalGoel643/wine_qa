...
The system uses a Random Forest Regressor trained on the wine quality dataset. Model predictions are categorized into three quality levels:
- Poor: quality < 5
- Average: 5 ≤ quality < 6
- Good: quality ≥ 6

Evaluation metrics include mean squared error and R² score tracked through experiment logging.

## Cloud Services Used

**Data Storage:** Azure Blob Storage  
**Model Deployment:** Azure App Service  
...
The API is deployed on Azure App Service and accessible at:
```
